...
import { SafeAreaView, View, Text, TouchableOpacity, StyleSheet, FlatList, Image, Platform, StatusBar as RNStatusBar } from 'react-native';
...
const operators = [
  ...
  { key: 'mtn_awuf', label: 'MTN Awuf', color: '#FFD400', localLogo: require('../../public/mtn-logo.png') },
